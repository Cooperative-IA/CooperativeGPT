...
# pyformat: disable
NOOP       = {"move": 0, "turn":  0, "fireZap": 0, "interact": 0}
FORWARD    = {"move": 1, "turn":  0, "fireZap": 0, "interact": 0}
STEP_RIGHT = {"move": 2, "turn":  0, "fireZap": 0, "interact": 0}
BACKWARD   = {"move": 3, "turn":  0, "fireZap": 0, "interact": 0}
STEP_LEFT  = {"move": 4, "turn":  0, "fireZap": 0, "interact": 0}
TURN_LEFT  = {"move": 0, "turn": -1, "fireZap": 0, "interact": 0}
TURN_RIGHT = {"move": 0, "turn":  1, "fireZap": 0, "interact": 0}
FIRE_ZAP   = {"move": 0, "turn":  0, "fireZap": 1, "interact": 0}
INTERACT   = {"move": 0, "turn":  0, "fireZap": 0, "interact": 1}
# pyformat: enable
...
def get_base_config():
  ...
  config.cooking_pot_pseudoreward = 0
...
def build(
  ...
  substrate_definition = dict(
      levelName="collaborative_cooking_crowded",
