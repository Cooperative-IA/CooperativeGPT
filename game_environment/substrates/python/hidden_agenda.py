...
# pyformat: disable
NOOP       = {"move": 0, "turn": 0, "fireZap": 0,  "tag": 0, "vote": 0}
FORWARD    = {"move": 1, "turn": 0, "fireZap": 0,  "tag": 0, "vote": 0}
STEP_RIGHT = {"move": 2, "turn": 0, "fireZap": 0,  "tag": 0, "vote": 0}
BACKWARD   = {"move": 3, "turn": 0, "fireZap": 0,  "tag": 0, "vote": 0}
STEP_LEFT  = {"move": 4, "turn": 0, "fireZap": 0,  "tag": 0, "vote": 0}
TURN_LEFT  = {"move": 0, "turn": -1, "fireZap": 0, "tag": 0, "vote": 0}
TURN_RIGHT = {"move": 0, "turn": 1, "fireZap": 0,  "tag": 0, "vote": 0}
FIRE_ZAP   = {"move": 0, "turn": 0, "fireZap": 1,  "tag": 0, "vote": 0}
TAG        = {"move": 0, "turn": 0, "fireZap": 0,  "tag": 1, "vote": 0}
...
def get_config(players: list[str]):
  ...
  config.recommended_num_players = len(players)
  ...
  config.scene_prefab = create_scene(len(players))
  ...
  config.valid_roles = frozenset({"crewmate",
                                  "impostor",})
  config.default_player_roles = ("crewmate",) * (len(players)-1) + ("impostor",)
...
def build(
  ...
  avatar_objects = []
  for player_idx, role in enumerate(config.default_player_roles):
