...
def reflect_insights(name, world_context, memory_statements, questions: list[str], agent_bio: str = "", prompts_folder = "base_prompts_v0", known_agent_interactions=None) -> list[str]:
    """
    ...
    try:
        response = llm.completion(prompt=prompt_path, inputs=[name, world_context, memory_statements, agent_bio, known_agent_interactions])
