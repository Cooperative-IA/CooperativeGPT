...
class GPT4oMini(BaseLLM):
    ...
    def __init__(self):
        ...
        """
        super().__init__(0.15/1e6, 0.60/1e6, 128000, 0.87)

        self.logger.info("Loading GPT-4o mini model from OPENAI API...")
        # Load the GPT-3.5 model
        self.client = OpenAI(
            api_key=os.getenv("OPENAI_KEY_GPT35")
        )
        self.deployment_name = os.getenv("OPENAI_GPT4o_MINI_MODEL_ID")
...
class GPT4o(BaseLLM):
    """Class for the GPT-4o model from OpenAI with 128K tokens of context"""
    ...
    def __init__(self):
        ...
        Args:
            ...
            response_token_cost (float): Cost of a token in the response
        """
        super().__init__(5/1e6, 15/1e6, 128000, 0.96)

        self.logger.info("Loading GPT-4o model from OPENAI API...")
        # Load the GPT-3.5 model
        self.client = OpenAI(
            api_key=os.getenv("OPENAI_KEY_GPT35")
        )
        self.deployment_name = os.getenv("OPENAI_GPT4o_MODEL_ID")
        # Encoding to estimate the number of tokens
        self.encoding = tiktoken.encoding_for_model("gpt-4o")
        
        self.logger.info("GPT-4o model loaded")
...
class Embedding(BaseLLM):
    """Class for the text-embedding-3-small model from OpenAI"""
    ...
    def __init__(self):
        ...
        Args:
            ...
            response_token_cost (float): Cost of a token in the response
        """
        super().__init__(0.00002/1000, 0, 8191, 1)

        self.logger.info("Loading text-embedding-3-small model...")
        # Load the Ada model
        self.client = OpenAI(
            api_key = os.getenv("OPENAI_KEY_GPT35"),  
        )
        ...
        self.logger.info("text-embedding-3-small model loaded")
